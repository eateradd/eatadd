<template>
	<div class="content f a_s" :style="{'padding': isphone ? '20px' : '100px 200px'}">
		<el-row :gutter="100" style="width: 100%;">
		  <el-col :sm="24" :md="1">
			  <div class="back_nav f a_c marr-10" style="padding-bottom: 20px;" @click="back">
		 ...
		 <el-col :sm="24" :md="20">
				  <div class="block">
					<el-timeline :reverse="reverse" class="line_nav">
					  <el-timeline-item v-for="(activity, index) in activities" :key="index" :timestamp="activity.content">
